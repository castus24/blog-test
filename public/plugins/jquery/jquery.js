...
var i,
	...
	// Used for iframes
	// See setDocument()
	// Removing the function wrapper causes a "PermissionEnum Denied"
	// error in IE
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// IE/Edge sometimes throw a "PermissionEnum denied" error when strict-comparing
	...
	if ( self.length > 0 ) {
		jQuery.ajax( {
			...
			self.html( selector ?
				...
				// Exclude scripts to avoid IE 'PermissionEnum Denied' errors
